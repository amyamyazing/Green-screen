...
File Summary
  ...
  - HDL source -
  /home/cc/cs150/sp13/class/cs150-ar/finalproj/dram/pcores/writecopimage_v1_00_a/hdl/vhdl
  top level      : writecopimage.vhd

  - XPS interface -
  /home/cc/cs150/sp13/class/cs150-ar/finalproj/dram/pcores/writecopimage_v1_00_a/data
  mpd            : writecopimage_v2_1_0.mpd
  pao            : writecopimage_v2_1_0.pao

  - ISE project -
  /home/cc/cs150/sp13/class/cs150-ar/finalproj/dram/pcores/writecopimage_v1_00_a/devl/projnav
  ise project    : writecopimage.xise
  tcl script     : writecopimage.tcl


  - XST synthesis -
  /home/cc/cs150/sp13/class/cs150-ar/finalproj/dram/pcores/writecopimage_v1_00_a/devl/synthesis
  xst script     : writecopimage_xst.scr
  xst project    : writecopimage_xst.prj

  - Misc file -
  /home/cc/cs150/sp13/class/cs150-ar/finalproj/dram/pcores/writecopimage_v1_00_a/devl
  help           : README.txt
  option         : ipwiz.opt
  log            : ipwiz.log

  - Driver source -
  /home/cc/cs150/sp13/class/cs150-ar/finalproj/dram/drivers/writecopimage_v1_00_a/src
  makefile       : Makefile
  header         : writecopimage.h
  source         : writecopimage.c

  - Driver interface -
  - user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  /home/cc/cs150/sp13/class/cs150-ar/finalproj/dram/drivers/writecopimage_v1_00_a/data
  mdd            : writecopimage_v2_1_0.mdd
  tcl            : writecopimage_v2_1_0.tcl
...
written into src/writecopimage.c in the Driver Directory.
...
implemented in hdl/vhdl/writecopimage.vhd in the Core Directory.
